...
### Test
- Update tests/test_screenshot_routing.py
...
- Update tests/test_screen_context.py
- Update tests/test_vql_capture_validation.py
...
### Other
- Update examples/dev-workflow/koru-audit-last-session.sh
- Update examples/dev-workflow/koru-drive-photo-vql.sh
- Update project/analysis.toon.yaml
- Update project/calls.mmd
- Update project/calls.png
...
### Test
- Update tests/test_session_recorder.py
...
- Update tests/test_vql_imgl_string_scene.py
- Update tests/test_wayland_input.py
...
### Other
- Update packages/vdisplay-agent/src/vdisplay_agent/server.py
- Update packages/vdisplay-agent/src/vdisplay_agent/services/sessions.py
- Update packages/vdisplay-agent/src/vdisplay_agent/services/tasks.py
- Update packages/vdisplay-agent/src/vdisplay_agent/task_store.py
- Update project/analysis.toon.yaml
- Update project/calls.mmd
- Update project/calls.png
- Update project/calls.toon.yaml
...
- Update docs/vision-only-wayland.md
- Update project/README.md
- Update project/context.md
...
- Update packages/vdisplay-agent/src/vdisplay_agent/broker_events.py
- Update packages/vdisplay-agent/src/vdisplay_agent/envelope.py
- Update packages/vdisplay-agent/src/vdisplay_agent/services/capabilities.py
- Update packages/vdisplay-agent/src/vdisplay_agent/services/capture.py
- Update packages/vdisplay-agent/src/vdisplay_agent/services/screencast_recovery.py
- Update packages/vdisplay-agent/src/vdisplay_agent/services/sessions.py
- Update project/analysis.toon.yaml
- Update project/calls.mmd
- Update project/calls.png
...
- Update .koru/event-store.jsonl
- Update .koru/events/observability.jsonl
- Update maps/pycharm-chat-fresh.json
- Update maps/pycharm-chat-input.json
