...
# vdisplay | 293f 35835L | python:283,shell:9,less:1 | 2026-06-10
# stats: 1363 func | 137 cls | 293 mod | CC̄=4.0 | critical:87 | cycles:0
# alerts[5]: CC global_pointer_coords=30; CC refresh_gui_map=24; CC diff_gui_map=23; CC _matches_selector=20; CC match_selector_boxes=20
# hotspots[5]: _start_screencast_impl fan=33; create_app fan=22; _portal_impl fan=22; diff_gui_map fan=22; register_routes fan=21
# evolution: baseline
...
M[293]:
  ...
  src/vdisplay/application/commands.py,293
  ...
  src/vdisplay/application/handlers/local.py,284
  ...
  src/vdisplay/application/services/control.py,707
  ...
  src/vdisplay/commands/control.py,157
  ...
  src/vdisplay/control/providers/atspi_impl.py,420
  src/vdisplay/control/providers/ax.py,170
  src/vdisplay/control/providers/ax_impl.py,256
  ...
  src/vdisplay/control/providers/uia_impl.py,269
  src/vdisplay/control/providers/vision/__init__.py,4
  src/vdisplay/control/providers/vision/provider.py,662
  ...
  src/vdisplay/control/scoring.py,751
  src/vdisplay/control/screenshot_verify.py,263
  src/vdisplay/control/selector.py,343
  src/vdisplay/control/session.py,217
  src/vdisplay/control/session_kind.py,16
  src/vdisplay/control/verifier.py,495
  src/vdisplay/control/verify.py,476
  ...
  src/vdisplay/control/vision_ocr.py,302
  ...
  src/vdisplay/input/coords.py,187
...
D:
  ...
  src/vdisplay/application/commands.py:
    e: _resolve_browser_engine_from_dsl,CommandVerb,CommandRequest,CommandResult
    CommandVerb:
  ...
  src/vdisplay/commands/control.py:
    e: register,_add_selector_args,handle
    register(sub)
  ...
  src/vdisplay/control/gui_map.py:
    e: load_gui_map,save_gui_map,_slug,tile_fingerprint,element_from_ocr_box,crop_png_bounds,_translate_ocr_boxes,parse_crop_bounds,_boxes_in_scope_for_build,build_gui_map_from_ocr,resolve_map_element,resolve_map_region,map_element_to_node,scoped_capture_region,verify_hints_from_map_element,resolve_map_verify_mode,GuiMapBounds,GuiMapPoint,GuiMapIdentity,GuiMapElement,GuiMapRegion,GuiMapPack
  ...
  src/vdisplay/control/gui_map_diff.py:
    e: _center,_distance,_box_to_bounds,_normalize_label,_labels_match,_boxes_in_scope,match_ocr_box_for_element,assess_map_drift,diff_gui_map,refresh_gui_map,ElementDrift,RegionDrift,GuiMapDiff
  ...
  src/vdisplay/control/policy.py:
    e: evaluate_provider_routing,_evaluate_readiness,assess_control_capability,ControlCapabilityContract
  ...
  src/vdisplay/control/providers/ax_impl.py:
    e: ax_deps_available,_role_from_ax,_ax_bounds,_matches_selector,filter_records,create_ax_backend,AxElementRecord,AxBackend,PyobjcAxBackend,MockAxBackend
    AxElementRecord:
  ...
  src/vdisplay/control/providers/uia_impl.py:
    e: uia_deps_available,_role_from_uia,_rect_to_bounds,_matches_selector,filter_records,create_uia_backend,UiaElementRecord,UiaBackend,ComtypesUiaBackend,MockUiaBackend
    UiaElementRecord:
  ...
  src/vdisplay/control/providers/vision/provider.py:
    ...
    VisionStubProvider: __init__(0),available(0),_capture_png(0),last_capture(0),last_find_debug(0),enable_preview_debug(1),_box_key(1),_record_find_debug(0),_node_from_ocr(1),_node_from_template(1),_node_from_anchor(1),_selector_wants_ocr(1),_find_nodes(1),_template_nodes_from_png(3),_anchor_nodes_from_png(3),_ocr_nodes_from_png(3),_stub_anchor_node(1),snapshot(0),find(1),_node_for(1),_click_node(1),invoke_map_node(1),focus_map_node(1),set_value_map_node(2),_pointer_click_at(1),invoke(1),focus(1),set_value(2),_paste_value(3),bounds(1)  # Canvas/game/stream surfaces — semantic tree unavailable; OCR
  ...
  src/vdisplay/control/screenshot_verify.py:
    e: _region_from_bounds,enrich_screencast_stream_meta,_resolve_screencast_stream_region,capture_control_screenshot,_target_region,_maybe_crop_capture,_capture_via_agent,diff_png_bytes,verify_screenshot_pair
  ...
  src/vdisplay/control/verifier.py:
    e: verify_spec_from_flags,_aggregate_dual,_aggregate_screenshot_only,_aggregate_semantic_only,default_verifier,VerifyContext,VerificationResult,VerifierPipeline
    VerifyContext:
    VerificationResult: to_dict(0)
    VerifierPipeline: _evaluate_runs(2),verify_after_action(1),_run_semantic(1),_run_visual(2),_run_ocr(3),_maybe_vision_llm_fallback(2),_run_anchor_visible(2),_aggregate(0)
  ...
  src/vdisplay/control/vision_ocr.py:
    e: ocr_available,ocr_png,_normalize,_box_matches,match_selector_boxes,ocr_find_selector,_vertical_overlap,_horizontal_overlap,anchor_spatial_relation,_find_anchor_boxes,anchor_spatial_find,anchor_based_find,ocr_anchor_combined_find,OcrTextBox
  ...
  src/vdisplay/input/coords.py:
    e: global_pointer_coords,_local_to_region_coords,_rotate_local_to_region,_aspect_mismatch,_rotation_for_monitor,_monitor_by_name
...
% ── Project Metadata ─────────────────────────────────────
project_metadata('vdisplay', '0.1.12', 'python').
...
project_file('src/vdisplay/application/commands.py', 293, 'python').
...
project_file('src/vdisplay/application/handlers/local.py', 284, 'python').
...
project_file('src/vdisplay/application/services/control.py', 707, 'python').
...
project_file('src/vdisplay/client.py', 408, 'python').
...
project_file('src/vdisplay/commands/control.py', 157, 'python').
...
project_file('src/vdisplay/control/gui_map.py', 500, 'python').
project_file('src/vdisplay/control/gui_map_diff.py', 437, 'python').
...
project_file('src/vdisplay/control/policy.py', 179, 'python').
...
project_file('src/vdisplay/control/providers/atspi_impl.py', 420, 'python').
project_file('src/vdisplay/control/providers/ax.py', 170, 'python').
project_file('src/vdisplay/control/providers/ax_impl.py', 256, 'python').
...
project_file('src/vdisplay/control/providers/uia_impl.py', 269, 'python').
project_file('src/vdisplay/control/providers/vision/__init__.py', 4, 'python').
project_file('src/vdisplay/control/providers/vision/provider.py', 662, 'python').
...
project_file('src/vdisplay/control/scoring.py', 751, 'python').
project_file('src/vdisplay/control/screenshot_verify.py', 263, 'python').
project_file('src/vdisplay/control/selector.py', 343, 'python').
project_file('src/vdisplay/control/session.py', 217, 'python').
project_file('src/vdisplay/control/session_kind.py', 16, 'python').
project_file('src/vdisplay/control/verifier.py', 495, 'python').
project_file('src/vdisplay/control/verify.py', 476, 'python').
...
project_file('src/vdisplay/control/vision_ocr.py', 302, 'python').
...
project_file('src/vdisplay/input/coords.py', 187, 'python').
...
python_function('src/vdisplay/application/services/control.py', '_attach_vision_preview', 1, 7, 7).
...
python_function('src/vdisplay/application/services/control.py', '_perform_action', 4, 14, 9).
python_function('src/vdisplay/application/services/control.py', '_capture_before_state', 0, 4, 1).
python_function('src/vdisplay/application/services/control.py', '_build_action_payload', 0, 6, 2).
python_function('src/vdisplay/application/services/control.py', '_execute_action', 0, 9, 15).
...
python_function('src/vdisplay/client.py', '_route_command', 1, 17, 5).
...
python_function('src/vdisplay/commands/control.py', 'handle', 1, 8, 9).
...
python_function('src/vdisplay/control/gui_map.py', 'build_gui_map_from_ocr', 2, 19, 19).
...
python_function('src/vdisplay/control/gui_map_diff.py', 'diff_gui_map', 3, 23, 22).
python_function('src/vdisplay/control/gui_map_diff.py', 'refresh_gui_map', 3, 24, 20).
...
python_function('src/vdisplay/control/policy.py', '_evaluate_readiness', 0, 18, 9).
python_function('src/vdisplay/control/policy.py', 'assess_control_capability', 0, 19, 9).
...
python_function('src/vdisplay/control/providers/atspi_impl.py', '_node_bounds', 1, 9, 5).
...
python_function('src/vdisplay/control/providers/ax_impl.py', '_matches_selector', 2, 17, 2).
...
python_function('src/vdisplay/control/providers/uia_impl.py', '_matches_selector', 2, 20, 3).
...
python_function('src/vdisplay/control/scoring.py', '_score_browser_provider', 2, 12, 4).
python_function('src/vdisplay/control/scoring.py', '_score_x11_provider', 2, 18, 6).
...
python_function('src/vdisplay/control/scoring.py', 'score_provider', 1, 16, 15).
...
python_function('src/vdisplay/control/screenshot_verify.py', '_resolve_screencast_stream_region', 0, 15, 10).
...
python_function('src/vdisplay/control/vision_ocr.py', 'match_selector_boxes', 2, 20, 6).
...
python_function('src/vdisplay/input/coords.py', 'global_pointer_coords', 3, 30, 9).
...
python_method('CommandRequest', 'from_dsl', 2, 23, 9).
...
python_method('ComtypesUiaBackend', 'collect_elements', 0, 9, 18).
...
python_method('VisionStubProvider', '_record_find_debug', 0, 11, 7).
...
python_method('VisionStubProvider', '_find_nodes', 1, 19, 8).
...
python_method('VisionStubProvider', '_paste_value', 3, 7, 4).
...
python_method('ControlSelector', 'active_fields', 0, 16, 4).
...
python_method('VerifierPipeline', '_evaluate_runs', 2, 16, 5).
python_method('VerifierPipeline', 'verify_after_action', 1, 34, 11).
python_method('VerifierPipeline', '_run_semantic', 1, 11, 5).
python_method('VerifierPipeline', '_run_visual', 2, 11, 5).
python_method('VerifierPipeline', '_run_ocr', 3, 22, 19).
