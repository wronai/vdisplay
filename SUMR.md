...
# code2llm | 305f 42605L | python:241,json:25,toml:11,shell:7,yaml:5,yml:5,proto:4,txt:2 | 2026-06-10
# generated in 0.11s
# CC̅=3.9 | critical:24/1798 | dups:0 | cycles:0

HEALTH[20]:
  🟡 CC    _run_ocr CC=23 (limit:15)
  🟡 CC    render_readme CC=31 (limit:15)
  🟡 CC    _nl_from_imgl_scene CC=17 (limit:15)
  🟡 CC    _build_control_diagnostics CC=17 (limit:15)
  🟡 CC    build_backend_scores CC=15 (limit:15)
  🟡 CC    _apply_drift_payload CC=15 (limit:15)
  🟡 CC    build_map_health CC=38 (limit:15)
  🟡 CC    _run CC=15 (limit:15)
  🟡 CC    context_to_vql_program CC=34 (limit:15)
  🟡 CC    _enrich_render_intent CC=28 (limit:15)
  🟡 CC    map_drift_blocks_cache CC=20 (limit:15)
  🟡 CC    ocr_boxes_from_cached_context CC=16 (limit:15)
  🟡 CC    observe_screen CC=22 (limit:15)
  🟡 CC    attach_imgl_to_context CC=15 (limit:15)
  🟡 CC    ocr_boxes_from_imgl CC=15 (limit:15)
  🟡 CC    dump_tree CC=22 (limit:15)
  🟡 CC    send_ide_prompt CC=27 (limit:15)
  🟡 CC    run_hmi_watch CC=38 (limit:15)
  🟡 CC    _mouse_device_paths CC=15 (limit:15)
  🟡 CC    _run CC=18 (limit:15)
...
PIPELINES[766]:
  [1] Src [main]: main → create_server
      PURITY: 100% pure
  [2] Src [create_server]: create_server → resolve_agent_url → _probe_default_agent → _probe_agent_url → ...(1 more)
      PURITY: 100% pure
  ...
  [37] Src [main]: main → uri_to_dsl
      PURITY: 100% pure
  [38] Src [main]: main → create_app → resolve_agent_url → _probe_default_agent → ...(2 more)
      PURITY: 100% pure
...
LAYERS:
  ...
  │ screenshot_verify          300L  0C   11m  CC=14     ←6
  │ uia_impl                   299L  4C   29m  CC=13     ←3
  │ !! keyboard                   297L  2C   10m  CC=15     ←0
  │ local                      291L  0C   21m  CC=4      ←1
  │ !! vql_bridge                 284L  0C    8m  CC=34     ←2
  ...
  │ !! backend_scores             214L  0C   13m  CC=15     ←3
  │ !! observe_cache              213L  0C   11m  CC=20     ←2
  │ client_api                 210L  1C   26m  CC=4      ←0
  │ query                      209L  0C    6m  CC=9      ←5
  │ !! mouse                      209L  2C   11m  CC=18     ←1
  ...
  │ !! map_health                 147L  0C    4m  CC=38     ←1
  │ policy                     140L  1C    4m  CC=11     ←2
  │ !! pipeline                   138L  0C    3m  CC=22     ←2
  ...
  │ !! imgl_bridge                116L  0C    5m  CC=15     ←4
  ...
  │ client_http                 96L  1C    7m  CC=5      ←0
  │ verify_policy               95L  0C    5m  CC=12     ←1
  │ agent_config                93L  0C    9m  CC=6      ←16
  ...
  │ cli_handlers                34L  0C    6m  CC=1      ←18
  ...
  │ pyproject.toml             176L  0C    0m  CC=0.0    ←0
...
COUPLING:
                 ...
                 src.vdisplay                           ──                            5                            7                           ←1                            1                           ←4                           ←3                           ←3                           ←1                           ←1                                                         1                                                                                     ←1  hub
      packages.vdisplay-agent                           32                           ──                                                                                      1                                                                                                                                                                                                                                                                                                    hub
  ...
  HUB: src.vdisplay/ (fan-in=57)
  HUB: examples.common/ (fan-in=10)
  HUB: packages.dsl2vdisplay/ (fan-in=16)
  SMELL: packages.vdisplay-agent/ fan-out=33 → split needed
  SMELL: src.vdisplay/ fan-out=14 → split needed
...
# redup/duplication | 46 groups | 239f 35814L | 2026-06-10
...
HOTSPOTS[7] (files with most duplication):
  ...
  src/vdisplay/client_routes.py  dup=24L  groups=1  frags=2  (0.1%)
...
DUPLICATES[46] (ranked by impact):
  ...
  [94948b88ff78a042]   STRU  _controls_list  L=4 N=5 saved=16 sim=1.00
      src/vdisplay/application/handlers/agent.py:182-185  (_controls_list)
      src/vdisplay/application/handlers/agent.py:188-191  (_controls_find)
      src/vdisplay/application/handlers/agent.py:194-197  (_control_click)
      src/vdisplay/application/handlers/agent.py:200-203  (_control_focus)
      src/vdisplay/application/handlers/agent.py:206-209  (_control_set_value)
  ...
  [2d7b9210c1b65241]   STRU  img2nl_enabled  L=3 N=5 saved=12 sim=1.00
      ...
      src/vdisplay/integrations/vql_bridge.py:13-15  (vql_enabled)
  ...
  [81fae0599a2d525e]   STRU  imgl_available  L=9 N=2 saved=9 sim=1.00
      ...
      src/vdisplay/integrations/vql_bridge.py:18-26  (vql_available)
  ...
  [5177a541164fa53c]   EXAC  _vdisplay_src_path  L=5 N=2 saved=5 sim=1.00
      src/vdisplay/capture/portal_screencast.py:731-735  (_vdisplay_src_path)
...
REFACTOR[46] (ranked by priority):
  ...
  [12] ○ extract_function   → src/vdisplay/utils/img2nl_enabled.py
  ...
  [13] ○ extract_function   → src/vdisplay/utils/_route_terminal_open.py
      WHY: 2 occurrences of 12-line block across 1 files — saves 12 lines
      FILES: src/vdisplay/client_routes.py
  [14] ○ extract_function   → src/vdisplay/utils/_prefer_imgl_annotate.py
  ...
  [15] ○ extract_function   → src/vdisplay/utils/_system_python.py
  ...
  [16] ○ extract_function   → packages/dsl2vdisplay/src/dsl2vdisplay/utils/_parse_mirror.py
      WHY: 2 occurrences of 10-line block across 1 files — saves 10 lines
      FILES: packages/dsl2vdisplay/src/dsl2vdisplay/grammar.py
  [17] ○ extract_function   → src/vdisplay/commands/utils/register.py
      WHY: 3 occurrences of 5-line block across 3 files — saves 10 lines
      FILES: src/vdisplay/commands/all_cmd.py, src/vdisplay/commands/monitors.py, src/vdisplay/commands/windows.py
  [18] ○ extract_function   → src/vdisplay/control/utils/_safe_info.py
      WHY: 2 occurrences of 10-line block across 1 files — saves 10 lines
      FILES: src/vdisplay/control/session.py
  [19] ○ extract_function   → examples/utils/build_example_ax.py
  ...
  [20] ○ extract_function   → src/vdisplay/integrations/utils/imgl_available.py
      WHY: 2 occurrences of 9-line block across 2 files — saves 9 lines
      FILES: src/vdisplay/integrations/imgl_bridge.py, src/vdisplay/integrations/vql_bridge.py
  [21] ○ extract_function   → src/vdisplay/utils/_default_virtual_backend.py
      WHY: 3 occurrences of 4-line block across 1 files — saves 8 lines
      FILES: src/vdisplay/api.py
  [22] ○ extract_function   → src/vdisplay/control/providers/utils/ax_deps_available.py
      WHY: 2 occurrences of 8-line block across 2 files — saves 8 lines
      FILES: src/vdisplay/control/providers/ax_impl.py, src/vdisplay/control/providers/uia_impl.py
  [23] ○ extract_function   → src/vdisplay/control/utils/_build_uia.py
      WHY: 3 occurrences of 4-line block across 1 files — saves 8 lines
      FILES: src/vdisplay/control/registry.py
  [24] ○ extract_function   → src/vdisplay/control/utils/_build_browser.py
      WHY: 3 occurrences of 4-line block across 1 files — saves 8 lines
      FILES: src/vdisplay/control/registry.py
  [25] ○ extract_function   → src/vdisplay/control/providers/utils/invoke.py
      WHY: 2 occurrences of 7-line block across 2 files — saves 7 lines
      FILES: src/vdisplay/control/providers/ax.py, src/vdisplay/control/providers/uia.py
  [26] ○ extract_function   → src/vdisplay/control/providers/utils/focus.py
      WHY: 2 occurrences of 7-line block across 2 files — saves 7 lines
      FILES: src/vdisplay/control/providers/ax.py, src/vdisplay/control/providers/uia.py
  [27] ○ extract_function   → src/vdisplay/control/utils/_atspi_ready.py
      WHY: 2 occurrences of 7-line block across 1 files — saves 7 lines
      FILES: src/vdisplay/control/scoring.py
  [28] ○ extract_function   → src/vdisplay/control/utils/_terminal_line_matches.py
      WHY: 2 occurrences of 7-line block across 1 files — saves 7 lines
      FILES: src/vdisplay/control/selector.py
  [29] ○ extract_function   → src/vdisplay/control/utils/control_focus_type_seconds.py
      WHY: 2 occurrences of 7-line block across 1 files — saves 7 lines
      FILES: src/vdisplay/control/timing.py
  [30] ○ extract_function   → src/vdisplay/control/providers/utils/find.py
  ...
  [31] ○ extract_function   → src/vdisplay/control/providers/utils/bounds.py
      WHY: 2 occurrences of 6-line block across 2 files — saves 6 lines
      FILES: src/vdisplay/control/providers/ax.py, src/vdisplay/control/providers/uia.py
  [32] ○ extract_function   → src/vdisplay/control/providers/utils/_matches_name_fields.py
      WHY: 2 occurrences of 6-line block across 2 files — saves 6 lines
      FILES: src/vdisplay/control/providers/ax_impl.py, src/vdisplay/control/providers/uia_impl.py
  [33] ○ extract_function   → src/vdisplay/control/providers/utils/_matches_selector.py
      WHY: 2 occurrences of 6-line block across 2 files — saves 6 lines
      FILES: src/vdisplay/control/providers/ax_impl.py, src/vdisplay/control/providers/uia_impl.py
  [34] ○ extract_function   → src/vdisplay/utils/_vdisplay_src_path.py
      WHY: 2 occurrences of 5-line block across 2 files — saves 5 lines
      FILES: src/vdisplay/capture/portal_screencast.py, src/vdisplay/control/providers/atspi.py
  [35] ○ extract_function   → examples/utils/_use_mock_backend.py
      WHY: 2 occurrences of 5-line block across 2 files — saves 5 lines
      FILES: examples/control-plugin-ax/src/vdisplay_example_ax_plugin/provider.py, examples/control-plugin-uia/src/vdisplay_example_uia_plugin/provider.py
  [36] ○ extract_function   → packages/dsl2vdisplay/src/dsl2vdisplay/utils/_screenshot_to_text.py
      WHY: 2 occurrences of 5-line block across 1 files — saves 5 lines
      FILES: packages/dsl2vdisplay/src/dsl2vdisplay/grammar.py
  [37] ○ extract_function   → src/vdisplay/control/utils/resolve_map_element.py
      WHY: 2 occurrences of 5-line block across 1 files — saves 5 lines
      FILES: src/vdisplay/control/gui_map_resolve.py
  [38] ○ extract_function   → src/vdisplay/integrations/utils/cache_dir.py
      WHY: 2 occurrences of 5-line block across 1 files — saves 5 lines
      FILES: src/vdisplay/integrations/observe_cache.py
  [39] ○ extract_function   → src/vdisplay/control/providers/utils/bounds.py
      WHY: 2 occurrences of 4-line block across 2 files — saves 4 lines
      FILES: src/vdisplay/control/providers/atspi.py, src/vdisplay/control/providers/terminal.py
  [40] ○ extract_function   → src/vdisplay/control/providers/utils/create_ax_backend.py
      WHY: 2 occurrences of 4-line block across 2 files — saves 4 lines
      FILES: src/vdisplay/control/providers/ax_impl.py, src/vdisplay/control/providers/uia_impl.py
  [41] ○ extract_function   → src/vdisplay/control/utils/_vertical_overlap.py
      WHY: 2 occurrences of 4-line block across 1 files — saves 4 lines
      FILES: src/vdisplay/control/vision_ocr.py
  [42] ○ extract_function   → src/vdisplay/input/utils/available.py
      WHY: 2 occurrences of 4-line block across 2 files — saves 4 lines
      FILES: src/vdisplay/input/linux_xdotool.py, src/vdisplay/input/linux_ydotool.py
  [43] ○ extract_function   → src/vdisplay/control/providers/utils/close_all.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/vdisplay/control/providers/browser_session.py, src/vdisplay/control/providers/terminal_session.py
  [44] ○ extract_function   → src/vdisplay/control/providers/utils/bounds.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/vdisplay/control/providers/vision/provider.py, src/vdisplay/control/providers/x11.py
  [45] ○ extract_function   → src/vdisplay/control/utils/vision_llm_fallback_enabled.py
      WHY: 2 occurrences of 3-line block across 1 files — saves 3 lines
      FILES: src/vdisplay/control/vision_llm.py
  [46] ○ extract_function   → src/vdisplay/windows/utils/looks_like_internal_class.py
      WHY: 2 occurrences of 3-line block across 1 files — saves 3 lines
...
METRICS-TARGET:
  dup_groups:  46 → 0
  saved_lines: 462 lines recoverable
```

### Evolution / Churn (`project/evolution.toon.yaml`)

```toon markpact:analysis path=project/evolution.toon.yaml
# code2llm/evolution | 1736 func | 199f | 2026-06-10
# generated in 0.01s

NEXT[10] (ranked by impact):
  [1] !! SPLIT           src/vdisplay/application/session_recorder.py
      WHY: 1018L, 3 classes, max CC=31
      EFFORT: ~4h  IMPACT: 31558

  [2] !! SPLIT-FUNC      run_hmi_watch  CC=38  fan=30
      WHY: CC=38 exceeds 15
      EFFORT: ~1h  IMPACT: 1140

  [3] !! SPLIT-FUNC      sample_pointer  CC=42  fan=24
      WHY: CC=42 exceeds 15
      EFFORT: ~1h  IMPACT: 1008

  [4] !! SPLIT-FUNC      context_to_vql_program  CC=34  fan=29
      WHY: CC=34 exceeds 15
      EFFORT: ~1h  IMPACT: 986

  [5] !! SPLIT-FUNC      send_ide_prompt  CC=27  fan=23
      WHY: CC=27 exceeds 15
      EFFORT: ~1h  IMPACT: 621

  [6] !! SPLIT-FUNC      build_map_health  CC=38  fan=16
      WHY: CC=38 exceeds 15
      EFFORT: ~1h  IMPACT: 608

  [7] !! SPLIT-FUNC      render_readme  CC=31  fan=19
      WHY: CC=31 exceeds 15
      EFFORT: ~1h  IMPACT: 589

  [8] !  SPLIT-FUNC      observe_screen  CC=22  fan=23
      WHY: CC=22 exceeds 15
      EFFORT: ~1h  IMPACT: 506

  [9] !! SPLIT-FUNC      _enrich_render_intent  CC=28  fan=18
      WHY: CC=28 exceeds 15
      EFFORT: ~1h  IMPACT: 504

  [10] !  SPLIT-FUNC      VerifierPipeline._run_ocr  CC=23  fan=20
...
RISKS[3]:
  ...
  ⚠ Splitting src/vdisplay/application/session_recorder.py may break 46 import paths
