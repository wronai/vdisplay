...
- **Languages**: python: 269, json: 25, toml: 11, shell: 7, yaml: 6
- **Analysis Mode**: static
- **Total Functions**: 2007
- **Total Classes**: 162
- **Modules**: 334
- **Entry Points**: 904
...
- `src.vdisplay.application.replay.replay_session` - 29 calls
...
- `src.vdisplay.commands.agent.register` - 27 calls
