...
BUILTIN_APPLICATION_PROFILES: tuple[ApplicationProfile, ...] = (
    ApplicationProfile(
        ...
        notes="GTK/Qt apps with AT-SPI enabled",
    ),
    ApplicationProfile(
    ...
    ApplicationProfile(
        ...
        kind="vision_only",
        preferred_providers=["vision"],
        fallback_providers=["x11"],
        selector_extensions=["vision"],
        verify_strategies=["screenshot", "ocr"],
        notes="Canvas, games, remote streams without semantic trees",
    ),
)
